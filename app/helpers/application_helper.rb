module ApplicationHelper
  ...
  def status_pill(status)
    ...
    when "active", "available", "accepted", "approved", "complete", "completed", "processed", "succeeded", "finalized", "ready", "connected", "verified", "paid", "eligible", "enrolled", "synced", "funded", "delivered", "viewed", "matched", "hired", "on_track", "closed", "resolved", "response_ready", "certificate_ready", "forecast_ready", "published", "low"
    ...
    when "failed", "expired", "denied", "critical", "high", "blocked", "overdue", "escalated", "rejected", "withdrawn", "at_risk", "missed", "coverage_gap", "missing_signature", "signature_invalid"
