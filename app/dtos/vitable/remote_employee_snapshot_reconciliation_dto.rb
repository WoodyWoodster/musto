module Vitable
  RemoteEmployeeSnapshotReconciliationDto = Data.define(
    ...
    def increment(processed_count: 0, matched_count: 0, updated_count: 0, unchanged_count: 0, unmatched_count: 0, unmatched_employer_count: 0, deduction_sync: PayrollDeductionSyncResultDto.empty)
      self.class.new(
