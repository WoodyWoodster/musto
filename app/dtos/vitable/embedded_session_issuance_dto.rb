module Vitable
  EmbeddedSessionIssuanceDto = Data.define(
    ...
    def validate_bound_entity!(expected_type:, expected_id:, response_label: "Vitable embedded session token response")
    ...
    def validate!(expected_type:, expected_id:, response_label: "Vitable embedded session token response")
