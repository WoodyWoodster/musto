module Vitable
  RunDemoCertificationDto = Data.define(
    ...
    def self.from_env(env = ENV, default_scope: "full", scope_override: nil, default_requested_by: "demo_certification")
      new(
        ...
        requested_by: env.fetch("VITABLE_CERTIFICATION_REQUESTED_BY", default_requested_by),
        ...
        scope: Vitable::CertificationMatrix.normalized_scope(scope_override.presence || env.fetch("VITABLE_CERTIFICATION_SCOPE", default_scope))
      )
    end
  end
end
