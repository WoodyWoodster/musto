module Vitable
  ApiSnapshotDto = Data.define(
    ...
    :enrollment_plan_updated_count,
    :enrollment_plan_unchanged_count,
    :enrollment_plan_conflict_count,
    ...
    def self.from_metadata(metadata)
      ...
      new(
        ...
        enrollment_plan_updated_count: counts.fetch("enrollment_plan_updated_count", 0),
        enrollment_plan_unchanged_count: counts.fetch("enrollment_plan_unchanged_count", 0),
        enrollment_plan_conflict_count: counts.fetch("enrollment_plan_conflict_count", 0),
