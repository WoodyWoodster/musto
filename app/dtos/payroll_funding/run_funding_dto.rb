module PayrollFunding
  RunFundingDto = Data.define(:id, :period_start_on, :period_end_on, :pay_date, :status, :employee_count, :net_pay_cents, :gross_pay_cents) do
    def self.from_payroll_detail(detail)
      ...
      new(
        ...
        gross_pay_cents: detail.gross_pay_cents
      )
    end
  end
end
