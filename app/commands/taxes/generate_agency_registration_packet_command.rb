module Taxes
  class GenerateAgencyRegistrationPacketCommand < ApplicationCommand
    ...
    def call
      return failure(errors: "No employer is available for tax agency registration packet generation") unless @employer
