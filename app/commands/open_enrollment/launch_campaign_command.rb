module OpenEnrollment
  class LaunchCampaignCommand < ApplicationCommand
    ...
    def call
      return failure(errors: "No employer is available for open enrollment") unless @employer

      batch = @repository.launch_campaign(requested_by: @dto.requested_by)
