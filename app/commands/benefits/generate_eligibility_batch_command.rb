module Benefits
  class GenerateEligibilityBatchCommand < ApplicationCommand
    ...
    def call
      return failure(errors: "No employer is available for benefits eligibility batching") unless @employer
