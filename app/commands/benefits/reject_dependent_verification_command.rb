module Benefits
  class RejectDependentVerificationCommand < ApplicationCommand
    ...
    def call
      return failure(errors: "No employer is available for dependent verification rejection") unless @employer

      verification = @repository.find_verification(@dto.verification_id)
      @repository.reject_verification(verification, reviewed_by: @dto.reviewed_by, issue_code: @dto.issue_code, note: @dto.note)
