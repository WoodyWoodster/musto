Rails.application.routes.draw do
  ...
  post "compliance/notices/:id/resolve", to: "compliance_notices#resolve", as: :resolve_compliance_notice
  ...
  post "integrations/vitable/census/remote-roster", to: "vitable_census_sync#refresh_remote_roster", as: :refresh_vitable_remote_roster
