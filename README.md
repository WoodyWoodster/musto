...
In development and test, Rails loads ignored `.env`, `.env.local`, and related dotenv files through `dotenv-rails`. Keep real keys in `.env.local`; only `.env.example` is committed.
